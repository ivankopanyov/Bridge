...
public partial class FiasCommonMessage
{
    ...
    [JsonIgnore]
    public TimeSpan? EFTTimeout1 => UserDefinableField0?.Split(';') is string[] timeouts && timeouts.Length > 0
    ...
    {
        get => Track2Data != null && decimal.TryParse(Track2Data, out decimal value)
            ? value : null;
