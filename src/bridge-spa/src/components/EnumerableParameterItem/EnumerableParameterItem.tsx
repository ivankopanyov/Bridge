...
export const EnumerableParameterItem: FC<
  Readonly<PropsWithChildren<EnumerableParameterItemProps>>
> = ({ editMode, onDeleteClick, children }) => {
  return (
    <div className="enumerable-parameter-item-container">
      {children}
      {editMode && (
        <IconButton
          className="enumerable-parameter-item-icon-button"
