...
const AccordionBox: FC<Readonly<PropsWithChildren<AccordionBoxProps>>> = ({
  title,
  fail,
  expanded,
  onChange,
  ...
  return (
    <Accordion
      className={`accordion-box ${
        fail ? "accordion-box-error" : "accordion-box-normal"
      }`}
    ...
    >
      ...
      <AccordionBody indent>{children}</AccordionBody>
    </Accordion>
  );
};
