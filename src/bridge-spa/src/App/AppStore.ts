...
export const signIn = createAsyncThunk(
  "auth/signIn",
  async (auth: Auth) => await api.post("/auth/signIn", auth)
);

export const signUp = createAsyncThunk(
  "auth/signUp",
  async (auth: Auth) => await api.post("/auth/signUp", auth)
);

export const signOut = createAsyncThunk(
  "auth/signOut",
  async () => await api.delete("/auth/signOut")
);
...
export const { unauthorized, setError } = appSlice.actions;
