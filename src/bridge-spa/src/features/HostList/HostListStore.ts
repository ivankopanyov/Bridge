...
export const reloadService = createAsyncThunk(
  "hostList/reloadService",
  async (service: ServiceInfo) =>
    await api.get(`/services/reload/${service.hostName}/${service.name}`)
);

export const updateService = createAsyncThunk(
  "hostList/updateService",
  async (service: SimpleServiceInfo) =>
...
const hostListSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(reloadService.pending, (state, action) =>
      pending(state, action)
    );
    builder.addCase(reloadService.rejected, (state, action) =>
      rejected(state, action)
    );
